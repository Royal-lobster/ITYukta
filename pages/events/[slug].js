      ...
      >
        <Box flex="1">
          ...
          <Text fontSize="md" mt={4} mb={8}>
            ...
            deserunt nihil rem eveniet. Culpa, quo harum! Maiores autem, ratione
            adipisci culpa, fugit, nulla eveniet excepturi exercitationem dolor
            sint mollitia quam natus omnis ipsam facilis. Placeat mollitia in
            quasi, natus dicta harum soluta error
          </Text>
          ...
          <Table variant="simple">
            ...
            <Tbody>
              ...
              <Tr>
                ...
                <Td>{eventData.Event_Fee ? eventData.Event_Fee : "Free"}</Td>
              </Tr>
            </Tbody>
          </Table>
        </Box>
